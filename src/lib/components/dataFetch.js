...
// om de informatie van de film te verkrijgen en op te slaan in movieData
        ...
        if (data.Response === "True") {
            for (const movie of data.Search) {
                ...
                movieData.push({
                    ...
                    poster: movie.Poster,
                    rating: detailsData.imdbRating * 10 ? detailsData.imdbRating * 10 : Math.floor(Math.random() * 50) + 50, // als de rating niet gedefinieerd is een random rating aanmaken
                    series: trilogy,
                });
            }
        }
